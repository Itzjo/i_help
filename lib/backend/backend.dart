...
import 'schema/users_location_record.dart';
...
export 'schema/users_location_record.dart';
...
Future<FFFirestorePage<EmergencyContactRecord>>
    queryEmergencyContactRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query UsersLocationRecords (as a Stream and as a Future).
Stream<List<UsersLocationRecord>> queryUsersLocationRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UsersLocationRecord.collection,
...
Future<List<UsersLocationRecord>> queryUsersLocationRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<UsersLocationRecord>> queryUsersLocationRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
